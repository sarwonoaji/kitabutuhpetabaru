...
<div class="h-10">
    <h4 class="text-2xl text-slate-900 text-center">
        Tambah Data Peta Kependudukan RT 2 / RW 1
    </h4>
</div>
<div class="min-h-screen bg-slate-100 py-10">
    <div class="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
        <div class="rounded-3xl bg-white p-8 shadow-xl ring-1 ring-slate-200">
            ...
            <form action="{{ route('penduduk21.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                    <div>
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
                    <a href="{{ route('penduduk21.index') }}" class="inline-flex items-center rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm transition hover:bg-slate-50">Kembali</a>
