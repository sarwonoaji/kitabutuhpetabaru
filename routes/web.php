...
// Grouped under auth:admin, kept original URLs
// -----------------------------
Route::middleware('auth:admin')->group(function () {
    // User admin management
    Route::get('/admin/user/create', [AdminUserController::class, 'create'])->name('useradmin.create');
    Route::post('/admin/user/store', [AdminUserController::class, 'store'])->name('useradmin.store');
    ...
    // Penduduk (many sections) - preserved original routes
...
// Penduduk map
Route::get('/penduduk/{id}', [PendudukMapController::class, 'show'])->name('penduduk.show');
...
// Generic login route (used by framework guest redirects)
